...
public class LoggingAdvice {
	 ...
	 */
	@Before("execution(* com.myspring.pro27.*.service.*.*(..)) or " + "execution(* com.myspring.pro27.*.dao.*.*(..))")
	 ...
	 * "execution(* com.myspring.pro27.member.dao.*.*(..))")
	 */
	@After("execution(* com.myspring.pro27.*.service.*.*(..)) or " + "execution(* com.myspring.pro27.*.dao.*.*(..))")
	 ...
	 * "execution(* com.myspring.pro27.member.dao.*.*(..))")
	 */
	@Around("execution(* com.myspring.pro27.*.service.*.*(..)) or " + "execution(* com.myspring.pro27.*.dao.*.*(..))")
